...
const data = {
  subTitle: 'E-Bonds platform',
  title: 'Supporting Bonds automation for established financial institutions.',
  features: [
    {
      id: 1,
      imgSrc: Briefcase,
      altText: 'Smart Features',
      title: 'Designed to meet your needs.',
      text:
        'The platform offers comprehensive Bonds services, from electronic signatures to automated bond issuance.',
    },
      {
          id: 2,
          imgSrc: Briefcase,
          ...
          text:
              'We provide a high level of legal compliance with requirements of many European banks and other countries.',
      },
    {
      id: 3,
      imgSrc: Secure,
      ...
      title: 'Global reach.',
      text:
        'Potential to drill down into the data and find a specific tender, buyer, or supplier you are looking for.',
    },
  ],
};
